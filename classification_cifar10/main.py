...
def get_ckpt_name(model='resnet', optimizer='sgd', lr=0.001, momentum=0.9,
...
def main():
    ...
    ckpt_name = get_ckpt_name(model=args.model, optimizer=args.optim, lr=args.lr, 
                                momentum=args.momentum,beta1=args.beta1,weight_decay = args.weight_decay,
                                eps = args.eps,beta2=args.beta2,reset=args.reset, run=args.run)
    print('ckpt_name')
    if args.resume:
