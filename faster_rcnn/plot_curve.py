...
def plot_loss_and_lr(train_loss, learning_rate):
    try:
        ...
        ax2.set_xlim(0, len(train_loss))  # Setting the horizontal coordinate integer interval
        plt.legend(loc='best')
        ...
        fig.subplots_adjust(right=0.8)  # Prevent saved images from being displayed incompletely
