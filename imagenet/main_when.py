...
parser.add_argument('--data', metavar='DIR',default='/home/ILSVRC2012',#'/data1/ILSVRC2012',#
...
parser.add_argument('--decay_epoch', default=30, type=int, metavar='N',
                    help='number of total epochs to run')
parser.add_argument('--start-epoch', default=89, type=int, metavar='N',
...
parser.add_argument('--wd', '--weight-decay', default=1e-4, type=float,
                    ...
                    dest='weight_decay')
parser.add_argument('--l1_decay', default=0.1, type=float)
