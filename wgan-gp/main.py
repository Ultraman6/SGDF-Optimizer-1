...
if __name__ == '__main__':
    ...
    if opt.optimizer == 'adam':
        optimizerD = Adam(netD.parameters(), lr=opt.lr, betas=(opt.beta1, opt.beta2), eps=opt.eps)
        optimizerG = Adam(netG.parameters(), lr=opt.lr, betas=(opt.beta1, opt.beta2), eps=opt.eps)
        ...
        optimizerD = SGD(netD.parameters(), lr=opt.lr)
        optimizerG = SGD(netG.parameters(), lr=opt.lr)
    ...
    elif opt.optimizer == 'sgdf':
        optimizerD = SGDF(netD.parameters(), lr=opt.lr, betas=(opt.beta1, opt.beta2),eps=opt.eps)
        optimizerG = SGDF(netG.parameters(), lr=opt.lr, betas=(opt.beta1, opt.beta2),eps=opt.eps)
